...
Open http://localhost:23519 in your browser.
...
⚠️ Known Limitations
NewsAPI free tier is localhost-only. For a publicly deployed app, you'll need a paid NewsAPI plan or swap to a free alternative like GNews (100 req/day) or Currents API (600 req/day).
